...
import main.java.ru.miet.testing.SimpleCalcPresenter;
...
class SimpleCalcTest {
    ...
    private final CalculatorPresenter calcPres = new SimpleCalcPresenter(mock);
    ...
    public void divideByZero() {
        mock.a = String.valueOf(Math.random());
        mock.b = String.valueOf(Math.random()*10e-9);
        calcPres.onDivideClicked();
